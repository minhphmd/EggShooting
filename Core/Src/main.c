...
const int lostMelody[] = {
  NOTE_C5, NOTE_G4, NOTE_E4, NOTE_A4, NOTE_B4, NOTE_F4, NOTE_C5
};
...
void playLostSound(TIM_HandleTypeDef *htim, uint32_t channel) {
    ...
    for (int i = 0; i < melodyLength; i++) {
        ...
        tone(htim, channel, lostMelody[i], noteDuration); // Phát âm thanh
...
int main(void)
{
  ...
  /* add queues, ... */
  Queue1Handle = osMessageQueueNew (1024, sizeof(uint8_t), &Queue1_attributes);
...
/* USER CODE BEGIN MX_GPIO_Init_2 */
  	/*Configure GPIO pin : PG2, PG3 for input */
    GPIO_InitStruct.Pin = GPIO_PIN_2 | GPIO_PIN_3;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);
    /*Configure GPIO pin : PA14 for input */
